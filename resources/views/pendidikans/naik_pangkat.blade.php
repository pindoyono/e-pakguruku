    ...
    <div class="col-md-12">
        <div class="card ">
            ...
            <form enctype="multipart/form-data" class="form-horizontal"
                action="{{ route('users.update_pak', Auth::user()->id) }}" method="POST">
                @csrf
                    ...
                    <div class="pull-left">
                        <h1>
                            ...
                            @if (Auth::user()->status_naik_pangkat == 'PAK TAHUNAN')
                                <span class="btn btn-danger ">{{ Auth::user()->status_naik_pangkat }}</span>
                            @else
                    ...
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                ...
                                @foreach ($pak as $item)
                                    @php
                                        $sum_tertinggal += sum_tertinggal($item->id);
                                        $tgl_periode_akhir = $item->akhir;
                                    @endphp
                                    <td scope="col">
                                        <span>
                                ...
                                <td scope="col" colspan="3">
                                    <input type="number" step="any" name="tertinggal" id="tertinggal"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->tertinggal }}"
                                        class="form-control">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="pendidikan_sekolah" id="sekolah"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->pendidikan_sekolah }}"
                                        class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="pelatihan_prajabatan" id="pra_jabatan"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->pelatihan_prajabatan }}"
                                        class="form-control">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="proses_pembelajaran"
                                        id="prose_pembelajaran" oninput="jml_utama();jml_semua();"
                                        value="{{ Auth::user()->proses_pembelajaran }}" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                <td scope="col">2</td>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="proses_bimbingan" id="proses_bimbingan"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->proses_bimbingan }}"
                                        class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="tugas_lain" id="tugas_lain"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->tugas_lain }}"
                                        class="form-control">
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="pengembangan_diri" id="pengembangan_diri"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->pengembangan_diri }}"
                                        class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="publikasi_ilmiah" id="karya_ilmiah"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->publikasi_ilmiah }}"
                                        class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="karya_inovatif" id="karya_inovatif"
                                        oninput="jml_utama();jml_semua();" value="{{ Auth::user()->karya_inovatif }}"
                                        class="form-control">
                                </td>
                            </tr>
                            <tr style="font-weight: 900;font-size: 20px;">
                                ...
                                <td scope="col">
                                    <span id="jml_utama">
                                        {{ $jml_utama_terakhir = number_format(
                            ...
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="ijazah_tidak_sesuai"
                                        id="ijazah_tidak_sesuai" oninput="jml_penunjang();jml_semua();"
                                        value="{{ Auth::user()->ijazah_tidak_sesuai }}" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="pendukung_tugas_guru"
                                        id="pendukung_tugas_guru" oninput="jml_penunjang();jml_semua();"
                                        value="{{ Auth::user()->pendukung_tugas_guru }}" class="form-control">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td scope="col">
                                    <input type="number" step="any" name="memperoleh_penghargaan" id="penghargaan"
                                        ...
                                        value="{{ Auth::user()->memperoleh_penghargaan }}" class="form-control">
                                </td>
                            </tr>
                            <tr style="font-weight: 900;font-size: 20px;">
                                ...
                                <td scope="col">
                                    <span>
                                        {{ number_format(
                                            $pak_first->ijazah_tidak_sesuai + $pak_first->pendukung_tugas_guru + $pak_first->memperoleh_penghargaan,
                                            3,
                                        ) }}
                                    </span></h4>
                                </td>
                                @foreach ($pak as $item)
                                    <td scope="col">
                                        <span>
                                            {{ number_format(
                                                ijazah_tidak_sesuai($item->id) + pendukung_tugas_guru($item->id) + memperoleh_penghargaan($item->id),
                                                3,
                                            ) }}
                                        </span>
                                    </td>
                                ...
                                <td scope="col">
                                    <span id="jml_penunjang">
                                        {{ $jml_penunjang_terakhir = number_format(
                                            Auth::user()->ijazah_tidak_sesuai + Auth::user()->pendukung_tugas_guru + Auth::user()->memperoleh_penghargaan,
                                            3,
                                        ) }}
                                    </span>
                                </td>
                            ...
                            <tr style="font-weight: 900;font-size: 20px;">
                                ...
                                <td scope="col">
                                    ...
                                    <div class="hide">pastikan angka pada kolom ini adalah angka kredit yg tertera pada
                                        SK kenaikan pangkat terakhir </div>
                                    {{-- </span> --}}
                                </td>
                            </tr>
                        </tbody>
        ...
        @endif --}}
                    ...
                    @php $jml_4 = ($ak_utama - (90/100*$jabatan->target_sebelum) ) + ($sum_tertinggal +  Auth::user()->tertinggal + $pak_first->tertinggal ) - (90/100*$jabatan->akk); @endphp
                    ...
                    <form enctype="multipart/form-data" class="form-horizontal"
                        action="{{ route('penilais.usul_naik_pangkat', $naik_pangkat) }}" method="POST">
                        @csrf
                        <input type="hidden" value="PUT" name="_method">
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $ak_utama - (90 / 100) * $jabatan->target_sebelum + ($sum_tertinggal + Auth::user()->tertinggal + $pak_first->tertinggal) }}
                                    </td>
                                    <td>{{ $pak_first->pengembangan_diri + $pengembangan_diri - Auth::user()->pengembangan_diri }}
                                    </td>
                                    <td>{{ $pak_first->publikasi_ilmiah + $pak_first->karya_inovatif + $karya_ilmiah + $karya_inovatif - (Auth::user()->publikasi_ilmiah + Auth::user()->karya_inovatif) }}
                                    </td>
                                ...
                                <tr style="font-weight: 900">
                                    ...
                                    <td style="{{ $jml_1 >= 0 ? 'color: green;' : 'color: red;' }}">{{ $jml_1 }}
                                    </td>
                                    <td style="{{ $jml_4 >= 0 ? 'color: green;' : 'color: red;' }}">{{ $jml_4 }}
                                    </td>
                                    <td style="{{ $jml_2 >= 0 ? 'color: green;' : 'color: red;' }}">{{ $jml_2 }}
                                    </td>
                                    <td style="{{ $jml_3 >= 0 ? 'color: green;' : 'color: red;' }}">{{ $jml_3 }}
                                    </td>
                                    <td style="{{ $jml_5 <= 0 ? 'color: green;' : 'color: red;' }}">{{ $jml_5 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="6"></td>
                                ...
                                <tr style="font-weight: 900">
                                    ...
                                    <td
                                        style=" {{ masa_kerja_tahun(\Carbon\Carbon::parse(\Carbon\Carbon::parse(now())->format('y') . '-' . get_periode() . '-31')->addMonths(1), Auth::user()->tmt_pns) >= 2 ? 'color: green;' : 'color: green;' }}">
                                ...
                                @if ($jabatan->id >= 4)
                                    <tr style="font-weight: 900">
                                        ...
                                        <td
                                            style="{{ $karya_inovatif + $pak_first->karya_inovatif - Auth::user()->karya_inovatif <= (50 / 100) * $jabatan->akpkbpiki ? 'color: green;' : 'color: red;' }}">
                                            Perolehan
                                            ({{ $karya_inovatif + $pak_first->karya_inovatif - Auth::user()->karya_inovatif }})
                                        </td>
                                        <td colspan="4"> Maksimal Karya Inovatif Yg di Bolehkan (
                                            {{ (50 / 100) * $jabatan->akpkbpiki }} )</td>
                                    </tr>
                        ...
                        <span> ** sebelum melakukan perhitungan pastikan isian di profile atau biodata sudah benar karena
