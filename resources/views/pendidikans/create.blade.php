...
<div class="col-md-12">
    <div class="card ">
      ...
      <div class="card-body">
        ...
        <form enctype="multipart/form-data" class="form-horizontal"  action="{{route('pendidikans.store1',$pak_id)}}" method="POST">
            @csrf
            ...
            <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    ...
                    <select name="kegiatan_id" data-style="select-with-transition" class="selectpicker" title="Pilih Kategori" data-live-search="true">
                        ...
                        <option  value="{{ $item->id }}">{{ Str::limit('['.$item->kode.']'.$item->kegiatan) }}</option>
                        @endforeach
                      </select>
                  </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="nilai" type="number" step="any" class="form-control">
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="row">
                <div class="col-md-4">
                    <input type="file" name="lampiran" required class="form-control" placeholder="">
                </div>
            </div>
