...
<div class="col-md-12">
    <div class="card ">
      ...
      <div class="card-body">
        ...
        <form enctype="multipart/form-data" class="form-horizontal"  action="{{route('lampiran2pkbs.store')}}" method="POST">
            @csrf
            <div class="row">
                <label class="col-sm-2 col-form-label">Kode</label>
                <div class="col-sm-10">
                    <div class="form-group">
                    <input class="form-control"  placeholder="Kode" type="text" name="kode" value="" required="true" aria-required="true">
