    ...
    <div class="container">
        ...
        <table width="100%">
            <tbody style="font-size:10;">
                ...
                <tr>
                    ...
                    <td class="spasi" style="text-align:right"> <b>
                ...
                <tr>
                    ...
                    <td class="spasi" style="text-align:right">
                        {{ $pak2->memperoleh_penghargaan != 0 ? str_replace('.', ',', $pak2->memperoleh_penghargaan) : '-' }}
                    </td>
                    <td class="spasi" style="text-align:right">
                        {{ $pak2->memperoleh_penghargaan2 != 0 ? str_replace('.', ',', $pak2->memperoleh_penghargaan2) : '-' }}
                    </td>
                    <td class="spasi" style="text-align:right">
                        {{ number_format($pak2->memperoleh_penghargaan + $pak2->memperoleh_penghargaan2, 3) != 0 ? str_replace('.', ',', number_format($pak2->memperoleh_penghargaan + $pak2->memperoleh_penghargaan2, 3)) : '-' }}
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="spasi" colspan="7">
                        <b>
                            @if ($naik_pangkat == 1)
                                Dapat dipertimbangkan untuk Kenaikan Pangkat, Golongan, TMT:
                                {{ $pangkat->pangkat_sebelum }} , PAK
                                {{ \Carbon\Carbon::parse(now())->format('m') <= 4 ? 'April' : 'Oktober' }} Tahun
                                {{ \Carbon\Carbon::parse(now())->format('Y') }}
                            @else
                                Tidak dapat dipertimbangkan untuk Kenaikan Pangkat, Golongan, TMT:
                                {{ $pangkat->pangkat_sebelum }} , PAK
                                {{ \Carbon\Carbon::parse(now())->format('m') <= 4 ? 'April' : 'Oktober' }} Tahun
                                {{ \Carbon\Carbon::parse(now())->format('Y') }}
                            @endif
        ...
        <table width="100%" style="font-size:10; border: none !important;vertical-align:top;align:right">
            <tr style="border: none !important;">
                ...
                <td width="160px"
                    style="border: none !important;vertical-align:top;font-size:11;white-space: nowrap;">
                    {{ $settings->kadis }},
                    <br>
                    <br>
                    <br>
