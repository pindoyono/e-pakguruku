...
class PenilaiController extends Controller
{
    ...
    public function cetak_asli($pak_id)
    {
        $data = DB::table('paks')
            ->join('users', 'users.id', '=', 'paks.user_id')
            ->where('paks.id', $pak_id)
    ...
    public function pleno()
    {
        if (Auth::user()->hasRole('super-admin')) {
            $data = DB::table('paks')
                ->select('paks.*', 'paks.id as pak_id', 'paks.created_at as tgl_buat', 'users.name', 'users.username', 'users.sekolah', 'users.no_hp', 'users.tmt_cpns', 'tmt_jabatan', 'sekolah', 'users.username as nip', 'users.pendidikan', 'jabatans.id as jabatan_id', 'users.pangkat_golongan', 'users.tertinggal as tertinggal_user', 'users.pengembangan_diri as pd_user',
