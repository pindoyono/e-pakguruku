...
class PlenosExport_tahunan implements FromView
{
    /**
    ...
    public function view(): View
    {
        if (Auth::user()->hasRole('super-admin')) {
            $data = DB::table('paks')
                ->select('paks.*', 'paks.id as pak_id', 'paks.created_at as tgl_buat', 'users.name', 'users.username', 'users.no_hp', 'users.sekolah', 'jabatans.id as jabatan_id', 'users.pangkat_golongan', 'users.tertinggal as tertinggal_user', 'users.pengembangan_diri as pd_user',
